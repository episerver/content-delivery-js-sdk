...
<template>
    <div class="ArtistDetailsPage">
        ...
        <div class="Page-container u-posRelative">
            ...
            <EpiProperty property-name="ArtistPhoto" />
            <EpiProperty property-name="ArtistGenre" />
            <EpiProperty property-name="ArtistIsHeadliner" />
...
<script>
import ArtistImage from '@/components/widgets/ArtistImage.vue';
